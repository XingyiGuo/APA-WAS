...
# APA-WAS Pipeline 
The APA-WAS analysis pipeline and R codes, detailed description of the example data/analysis, and expected results were provided bleow. We used results for our reported candiate susceptiblity gene, KDSR, in breast cancer as an example.
...
3. `samtools (v1.9)`
4. `USCS tools (v1.04.00)`
5. `R (v4.0.5)`
6. `PEER (v1.3), https://github.com/PMBio/peer`
